...
class HumanResourcesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('departements')->insert([
            [
                'name' => 'HR',
                'description' => 'Departement Human Resources',
                'status' => 'active',
            ...
            [
                'name' => 'IT',
                'description' => 'Departement Information Tech',
                'status' => 'active',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
              ],
    ...
    [
        ...
        'deductions' => $faker->randomFloat(2, 3000, 6000),
    ...
    [
        ...
        'updated_at' => Carbon::now(),
            ...
            DB::table('presences')->insert(
                [
                    'employee_id' => 1,
                    'check_id' => Carbon::parse('2026-02-10 09:00:00'),
                    'check_out' => Carbon::parse('2026-02-12 09:00:00'),
            ...
            DB::table('leave_requests')->insert(
                [
                    'employee_id' => 1,
                    'leave_type' => 'pending',
                    'start_date' => Carbon::parse('2026-07-22'),
