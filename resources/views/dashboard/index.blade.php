...
<div class="page-content"> 
    ...
    <script src="{{ asset('mazer/assets/static/js/components/d') }}ark.js"></script>
    <script src="{{ asset('mazer/assets/extensions/perfect-scr') }}ollbar/perfect-scrollbar.min.js"></script>
    
    
    < src="{{ asset('mazer/assets/compiled/js/app.js"></') }}script>
    

    
<!-- Need: Apexcharts -->
<script src="{{ asset('mazer/assets/extensions/apexcharts/') }}apexcharts.min.js"></script>
<script src="{{ asset('mazer/assets/static/js/pages/dashbo') }}ard.js"></script>
